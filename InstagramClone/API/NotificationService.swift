...
struct NotificationService {
    static func userFollowed(notifOwner: User, user: User,  completion: @escaping(FirestoreCompletion) ) {
    ...
    static func postLiked(user: User, post: Post, completion: @escaping(FirestoreCompletion)) {
    ...
    static func commentedPost(user: User, post: Post, comment: Comment, completion: @escaping(FirestoreCompletion)) {
        guard user.uid != post.uid else { return }
    ...
    static func postUnliked(user: User, post: Post, completion: @escaping(FirestoreCompletion) -> ()) {
        guard user.uid != post.uid else { return }
    ...
    static func unfollowed(notifOwner: User, user: User,  completion: @escaping(FirestoreCompletion) -> ()) {
